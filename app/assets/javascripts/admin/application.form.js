...
Application.Form.Init = function() {
  $('div.flash').delegate('span', 'click', Application.Form.CloseFlash);
  $('div#curation_grid div.grid-prefix').delegate('select', 'change', Application.Form.ChangeSpecies);
  $('div#curation_grid').delegate('label.curate', 'click', Application.Form.Curate);
  $('div#curation_grid').delegate('label.uncurate', 'click', Application.Form.Uncurate);
